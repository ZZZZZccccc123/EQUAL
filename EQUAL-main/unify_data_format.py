def get_content_dataset(raw_datasets, count, **kwargs):
    result = []
...
def get_text_dataset(raw_datasets, count, **kwargs):
    result = []
    for example in raw_datasets:
        count = count + 1
...
def get_question_dataset(raw_datasets, count, **kwargs):
    result = []
    for example in raw_datasets:
        count = count + 1
...
def get_unify_dataset(raw_datasets, count, **kwargs):
    if "content" in raw_datasets.column_names:
        return get_content_dataset(raw_datasets, count, **kwargs)
    elif "text" in raw_datasets.column_names:
        return get_text_dataset(raw_datasets, count, **kwargs)
    elif "question" in raw_datasets.column_names and "answer" in raw_datasets.column_names:
        return get_question_dataset(raw_datasets, count, **kwargs)
    else:
